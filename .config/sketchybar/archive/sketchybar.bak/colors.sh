...
# Bar and item colors
export BAR_COLOR=$(getcolor black 85)
...
export POPUP_BACKGROUND_COLOR=$(getcolor white 25)
export POPUP_BORDER_COLOR=$(getcolor white 0)
export SHADOW_COLOR=$(getcolor white)
export TRANSPARENT=$(getcolor white 0)
